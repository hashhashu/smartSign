...
//    final NumberData numberData=(NumberData)getApplication();
...
//                Toast.makeText(SignActivity.this,"aaaaaaaaaaaaaaa",Toast.LENGTH_LONG).
                if(isPosition){
//                    String type = "ssign";
//                    sendRequestWithHttpURLConection2(type,number,course);
                    data.setCourse(course);
                    Intent intent = new Intent(SignActivity.this,ChooseFunctionActivity.class);
...
//            Toast.makeText(SignActivity.this,"aaaaaaaaaaaaaaa",Toast.LENGTH_LONG);
            Log.d("isFirstLoc", String.valueOf(isFirstLoc));
